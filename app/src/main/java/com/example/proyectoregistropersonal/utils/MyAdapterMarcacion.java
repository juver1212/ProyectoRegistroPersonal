...
public class MyAdapterMarcacion extends SimpleCursorAdapter implements SectionIndexer {
    ...
    public MyAdapterMarcacion(Context context, int layout, Cursor c, String[] from, int[] to) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        txtDocumento.setText("Marcaciones registradas: "+Conteo);
