...
public class MyAdapterRegistrarMarcacion extends SimpleCursorAdapter implements SectionIndexer {
    ...
    public MyAdapterRegistrarMarcacion(Context context, int layout, Cursor c, String[] from, int[] to) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int ultimaMarcacion_ = cursor.getColumnIndex("ultimaMarcacion");
        int Foto_ = cursor.getColumnIndex(DatabaseHelper.Foto);

        String Nombre = cursor.getString(Nombre_);
        String ultimaMarcacion = cursor.getString(ultimaMarcacion_);
        ...
        txtDocumento.setText("Fecha Ult.:"+ultimaMarcacion == null ? "-" : ultimaMarcacion);
